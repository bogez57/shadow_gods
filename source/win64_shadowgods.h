...
namespace Win32
{
    ...
    {
        HMODULE DLLHandle {};
        void (*UpdateFunc)(Application_Memory*, Platform_Services*, Game_Render_Cmd_Buffer*, Game_Sound_Output_Buffer*, Game_Input*);
...
using GameUpdateFuncPtr = void (*)(Application_Memory*, Platform_Services*, Game_Render_Cmd_Buffer*, Game_Sound_Output_Buffer*, Game_Input*);
