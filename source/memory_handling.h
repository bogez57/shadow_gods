...
i32 CreateRegionFromMemory(Application_Memory* Memory, i64 size, Allocator_Type allocatorType);
...
i32 CreateRegionFromMemory(Application_Memory* appMemory, i64 size, Allocator_Type allocatorType)
{
