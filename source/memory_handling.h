...
#define CallocType(Type, Count) (Type*)_CallocType(&GlobalGameState->DynamicMem, ((sizeof(Type)) * (Count)))
#define CallocSize(Type, Count) _CallocType(&GlobalGameState->DynamicMem, (Size))
