...
#define MallocType(MemRegionIdentifier, Type, Count) (Type*)globalPlatformServices->Malloc(((sizeof(Type)) * (Count))) //(Type*)_MallocSize(MemRegionIdentifier, ((sizeof(Type)) * (Count)))
#define MallocSize(MemRegionIdentifier, Size) globalPlatformServices->Malloc(Size)//_MallocSize(MemRegionIdentifier, (Size))
#define CallocType(MemRegionIdentifier, Type, Count) (Type*)globalPlatformServices->Calloc(1, ((sizeof(Type)) * (Count)))//(Type*)_CallocSize(MemRegionIdentifier, ((sizeof(Type)) * (Count)))
#define CallocSize(MemRegionIdentifier, Size) globalPlatformServices->Calloc(1, (Size))//_CallocSize(MemRegionIdentifier, (Size))
#define ReAllocType(MemRegionIdentifier, Ptr, Type, Count) (Type*)globalPlatformServices->Realloc(Ptr, (sizeof(Type)) * (Count))//(Type*)_ReAlloc(MemRegionIdentifier, Ptr, sizeof(Type) * Count)
#define ReAllocSize(MemRegionIdentifier, Ptr, Size) globalPlatformServices->Realloc(Ptr, Size)//_ReAlloc(MemRegionIdentifier, Ptr, Size)
#define DeAlloc(MemRegionIdentifier, PtrToMemory) globalPlatformServices->Free((void*)PtrToMemory)//_DeAlloc(MemRegionIdentifier, (void**)&PtrToMemory)
