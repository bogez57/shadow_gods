...
Basis ProduceCameraBasis(Array<v4f, NUM_VERTS> worldCoords, v3f theoreticalCameraPlacement_inWorld, v3f rotation, v3f scale)
{
    Basis resultBasis{};
...
v3f TransformVector_ToCamera(v3f localCoords, Basis cameraBasis)
{
