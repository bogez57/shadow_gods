...
Memory_Region CreateRegionFromGameMem_1(Game_Memory* GameMemory, i64 Size)
{
    ...
    newRegion.BaseAddress = (i64*)((i8*)GameMemory->TemporaryStorage) + GameMemory->TemporaryStorageUsed;
    newRegion.EndAddress = (i64*)((i8*)newRegion.BaseAddress) + (Size - 1);
    newRegion.Size = Size;
...
auto _AllocType(Memory_Region* MemRegion, i64 size, i64 Count) -> void*
{
...
auto _AllocSize(Memory_Region* MemRegion, i64 size) -> void*
{
    BGZ_ASSERT((MemRegion->UsedAmount + size) <= MemRegion->Size, "Memory requested, %x bytes, greater than maximum region size of %x bytes!", (MemRegion->UsedAmount + size), MemRegion->Size);
    void* Result = MemRegion->BaseAddress + MemRegion->UsedAmount;
...
auto _FreeSize(Memory_Region* MemRegion, i64 sizeToFree) -> void
{
