...
void EndTimer(Timer* timer)
{
    ...
    uint64_t delta = ((endTime - timer->startCycles_count) | ((uint64_t)timer->hitCountInit << 40));//So first 3 bytes are reserved for hit count number and last 5 bytes reserved for num of cycles elapsed
